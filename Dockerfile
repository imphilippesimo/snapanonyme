...
#Set these variables at build time
ARG SNAPANONYM_DB_HOST=192.168.99.100
ARG SNAPANONYM_DB_PORT=3306
ARG SNAPANONYM_DB_NAME=snapanonyme
ARG SNAPANONYM_DB_USER=root
#ARG SNAPANONYM_DB_PASSWORD="root"
...
ENV SPRING_OUTPUT_ANSI_ENABLED=ALWAYS \
    ...
    SNAPANONYM_DB_HOST=${SNAPANONYM_DB_HOST}\
    SNAPANONYM_DB_PORT=${SNAPANONYM_DB_PORT}\
    SNAPANONYM_DB_NAME=${SNAPANONYM_DB_NAME}\
    SNAPANONYM_DB_USER=${SNAPANONYM_DB_USER}\
